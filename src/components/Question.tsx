...
const Question: React.FC<Props> = ({ questionInfo }) => {
    ...
    const questionStyle = "font-semibold text-2xl xs:text-xl leading-tight "; // Sorunun stilini tanımlar
    const question = questionInfo?.title; // Soru başlığını alır

    return (
        // Soru ve seçenekleri içeren ana div
        <div className='flex  xs:w-full  xs:p-2 flex-col w-full gap-y-5 mx-auto text-center overflow-hidden'>
